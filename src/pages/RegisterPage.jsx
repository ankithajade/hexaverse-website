            ...
            <>
              ...
              <ScrollReveal className="mega-card" style={{ marginBottom: '32px', padding: '28px 32px' }}>
                ...
                {isTeam ? (
                  ...
                  >
                    <span style={{ color: 'var(--dark)', fontWeight: 500 }}>Team Size:</span>
                  ...
                  >
                    <span style={{ color: 'var(--dark)', fontWeight: 500 }}>Participation:</span>
                    <strong style={{ color: 'var(--cyan)' }}>Individual</strong>
                  </div>
                ) : null}
